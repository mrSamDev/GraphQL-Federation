...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    desc: 'Each subgraph owns its domain types. Entity references (@key directives) let subgraphs extend types defined elsewhere — Reviews extends Movie to add avgRating.',
  },
  {
    step: '04',
    ...
    <div className="max-w-[860px] transition-[filter] duration-[600ms]" style={matrixMode ? { filter: 'hue-rotate(90deg) saturate(2)' } : undefined}>
      <div className="mb-12">
        ...
        <p className="m-0 max-w-[640px] text-[15px] leading-[1.7] text-text-muted">
          MovieDB is a <strong className="text-text">GraphQL Federation</strong> platform — four independent subgraph
